...
function showDiagnosis() {
   let symptomsDiagnosis = "Symptoms of Strabismus: ";
   let typesDiagnosis = "Types of Strabismus: ";
   const form = document.getElementById('strabismusForm');

   if (form['diplopia'].value === 'yes') symptomsDiagnosis += "Diplopia detected. ";
   if (form['amblyopia'].value === 'yes') symptomsDiagnosis += "Amblyopia detected. ";
   
   if (form['esotropia'].value === 'yes') typesDiagnosis += "Esotropia detected. ";
   if (form['exotropia'].value === 'yes') typesDiagnosis += "Exotropia detected. ";
   if (form['hypotropia'].value === 'yes') typesDiagnosis += "Hypotropia detected. ";
   if (form['hypertropia'].value === 'yes') typesDiagnosis += "Hypertropia detected. ";

   const resultDiv = document.getElementById('diagnosisResult');
   resultDiv.innerHTML = `<strong>${symptomsDiagnosis}</strong><br><strong>${typesDiagnosis}</strong>`;
